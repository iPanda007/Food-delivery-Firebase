...
const HomeContainer = () => {
  return (
    ...
    <div className='py-2 relative flex items-center mt-12 md:mt-0'>
            ...
            <div className="w-full  h-full absolute top-0 left-0 2xl:left-[10%] flex items-center justify-center flex-wrap gap-4 mt-10 md:mt-0 2xl:px-[80px] 3xl:px-[120px] ">
                  { heroData && heroData.map(n =>(
                  <div key={n.id} className=" w-[150px]   mb-12 md:mb-0 lg:min-w-[250px] 2xl:w-[200px]  p-4 shadow flex items-center justify-center flex-col rounded-3xl bg-cardOverlay backdrop-blur-md ">
                       <img src={n.imageSrc} className=" w-22 md:w-22 lg:w-40 2xl:w-47 -mt-20" alt='I1'/>
